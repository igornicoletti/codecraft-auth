...
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => {
  return (
    <div className="grid min-h-svh place-content-center">
      <div className="relative font-semibold perspective-[1000px]">
        <motion.span
          animate={{
            skewY: [0, -40, 0],
            scaleX: [1, 2, 1],
        ...
        <motion.span
          className="absolute inset-0 text-primary/50 blur-[0.5px] dark:text-primary"
          animate={{
            x: [-2, 4, -3, 1.5, -2],
            y: [-2, 4, -3, 1.5, -2],
        ...
        <motion.span
          className="absolute inset-0 text-primary/50 dark:text-primary"
          animate={{
            x: [0, 1, -1.5, 1.5, -1, 0],
            y: [0, -1, 1.5, -0.5, 0],
