...
const lazyImport = <M extends Record<string, ComponentType<any>>, K extends keyof M>(factory: () => Promise<M>, name: K): LazyExoticComponent<M[K]> => {
...
export const LazyLoaded = {
  ...
  ProtectedRoute: lazyImport(() => import('@/features/route/protected-route'), 'ProtectedRoute'),
  PublicRoute: lazyImport(() => import('@/features/route/public-route'), 'PublicRoute'),
  NotFoundPage: lazyImport(() => import('@/features/route/not-found'), 'NotFoundPage'),
}
